---
title: "Visual Search: Finding Anything Across Your Cameras"
description: "Search for any object or situation across your cameras using a plain-language description."
---

# Visual Search: Finding Anything Across Your Cameras

Search lets you find any object or situation across your live video cameras using a plain-language description, no need to already know which camera or exact time to look at.
...
[SCREENSHOT: Search page - search bar with camera/time filters]
...
[SCREENSHOT: Camera and time range filter dropdowns]
...
[SCREENSHOT: Search bar with example query entered, previous searches list below]
...
[SCREENSHOT: Grid + Map view of search results]
...
[SCREENSHOT: Video player with What AI Sees and Explore Similar buttons]
