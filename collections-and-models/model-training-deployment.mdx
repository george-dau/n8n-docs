...
- This is the information that later feeds into the [workflow builder's](/agents-and-workflows/overview) evaluation logic, it's how the system knows _where_ to look for an event, not just _what_ to look for.
