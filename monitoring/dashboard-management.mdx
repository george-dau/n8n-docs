...
![Worlds Dashboard Management](/images/Worlds_DashboardManagement.png "Worlds Dashboard Management")
...
![Worlds Dashboard Layout](/images/Worlds_DashboardLayout.png "Worlds Dashboard Layout")

## Step 2: Manipulate Your Canvas
...
![Worlds Dashboard Widget](/images/Worlds_DashboardWidget.png "Worlds Dashboard Widget")

## Step 4: Choose a Data Source

The labels at the top of the widget present options for compatible data sources. Many widgets only offer Event Activity as a data source, since visualizing the output of your workflows is the primary use case. Some widgets, like Total Count, can also pull from Tracks (individual detections by tracked position), Zones, or Devices (cameras).

Select a data source, then click **Continue** to configure it.

## Step 5 (Optional): Add to a Section

You can also add a widget to a top or bottom section within the same space, useful for grouping visualizations that share the same filters, for example, pairing total event counts by priority with a line chart of the same events over time.
...
![Worlds Widget Core Data](/images/Worlds_WidgetCoreData.png "Worlds Widget Core Data")
...
![Worlds Widget Display](/images/Worlds_WidgetDisplay.png "Worlds Widget Display")
...
- Click and drag from the top to move, or from the bottom-right to resize existing widgets
...
![Worlds Custom Dashboard](/images/Worlds_CustomDashboard.png "Worlds Custom Dashboard")
...
![Worlds Custom Widget](/images/Worlds_CustomWidget.png "Worlds Custom Widget")
...
![Worlds Widget Code](/images/Worlds_WidgetCode.png "Worlds Widget Code")
