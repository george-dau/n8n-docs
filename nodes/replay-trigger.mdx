...
<Tabs>
  ...
  <Tab title="Query">
    ...
    | **Tags** | Multi-select | Object types to include. Leave empty to include all tags. |
    ...
    <Note>
      The time range cannot exceed 24 hours. For longer periods, create one replay session per day.
    </Note>
  </Tab>
</Tabs>
