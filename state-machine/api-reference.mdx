...
| `heartbeat_seconds` | Number | `30` | Maximum seconds between emissions for an unchanged composition. Only meaningful when `zone_emit_mode` is `"composition"`. Must be `>= 0`. |
